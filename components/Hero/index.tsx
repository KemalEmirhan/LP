  ...
  return (
    <section className="flex flex-col w-full h-screen items-center justify-center" id="hero" ref={ref}>
      <div className="flex flex-col items-center gap-4 z-10 text-center max-w-[900px]">
        ...
        <Link href="#signup-form" className="bg-[#ffd233] cursor-pointer text-black px-6 py-4 rounded-md w-fit text-lg font-bold hover:bg-[#ffd233]/90 transition-[colors,scale] duration-150 active:scale-97">Let&apos;s Calculate Your Savings</Link>
      </div>
