    ...
    <nav className={`flex justify-between items-center p-4 w-full max-w-7xl z-20 sticky bg-white mx-auto h-[72px] md:rounded-2xl top-0 md:top-4 transition-[max-width] duration-150 ease-out shadow-sm ${
      ...
      {showCTA && (
        <div className="animate-show-up">
          <Link href="#signup-form" className="bg-[#ffd233] text-black cursor-pointer px-2 md:px-6 py-2 rounded-md w-full md:w-fit text-base font-bold hover:bg-[#ffd233]/90 transition-[colors,scale] duration-150 active:scale-97">Get Your Heat Pump</Link>
        </div>
      )}
    </nav>  
  );
